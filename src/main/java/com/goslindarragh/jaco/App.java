package com.goslindarragh.jaco;
...
public	class	App	
{
				...
				//	should	be	of	the	form	jdbc:sqlite:database/goslindarragh.db
								...
								String	dbURL	=	null;
									...
									try
												{	
																...
																{
																				System.out.println("jaco	version	:	"	+	VERSION);
																				System.exit(0);
																}
										 ...
										 catch	(IndexOutOfBoundsException	iobEx)
										 {
										 	 ...
										 	 System.out.println("expecting	the	filename	to	be	specified	as	follows	>	jdbc:sqlite:database/goslindarragh.db");
										 	 System.exit(0);	
										 }
					}//EOM
